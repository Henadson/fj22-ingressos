...
public class SessaoTeste {
	...
	public void garantequeOLugarA1EstaOcupadoEOsLugaresA2EA3Disponiveis() {
		...
		Filme rougueOne = new Filme("Rougue One", Duration.ofMinutes(120), "SCI-FI", new BigDecimal("8.5"));
	
		Sala eldorado7 = new Sala("Eldorado 7", new BigDecimal("8.5"));
		
		Sessao sessao = new Sessao(LocalTime.parse("10:00:00"),eldorado7 , rougueOne);
